...
%antonio nunes - com a aprox das folhas
% a=[
% deriv.xu deriv.xw -cond_ini.u0*tan(cond_ini.aa0) -g*cos(cond_ini.tt0);
...
% deriv.xu deriv.xw -w0 -g*cos(cond_ini.tt0) 0;
% deriv.zu/(1-deriv.zwp) deriv.zw/(1-deriv.zwp) (cond_ini.u0+deriv.zq)/(1-deriv.zwp) -g*sin(cond_ini.tt0)/(1-deriv.zwp) 0;
% (deriv.mwp*deriv.zu/(1-deriv.zwp)) (deriv.mw+deriv.mwp*deriv.zw/(1-deriv.zwp)) (deriv.mq+deriv.mwp*(cond_ini.u0+deriv.zq)/(1-deriv.zwp)) -deriv.mwp*g*sin(cond_ini.tt0)/(1-deriv.zwp) 0;
% 0 0 1 0 0;
% 0 -1 0 cond_ini.u0 0];
...
%aprox das folhas - da o mesmo q as formulas de estabilidade
% a_fug=[
% deriv.xu -g;
% -deriv.zu/cond_ini.u0 0];

%formulas de estabilidade
%wn_fug_aprox = sqrt(-deriv.zu*g/cond_ini.u0);
%xi_fug_aprox = -deriv.xu/2/wn_fug_aprox;
...
a_pc=[
deriv.zw/(1-deriv.zwp) (cond_ini.u0+deriv.zq)/(1-deriv.zwp);
deriv.mw+deriv.mwp*deriv.zw/(1-deriv.zwp) (deriv.mq+deriv.mwp*(cond_ini.u0+deriv.zq)/(1-deriv.zwp))];
